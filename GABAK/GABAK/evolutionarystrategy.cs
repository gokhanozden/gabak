...
namespace GABAK
{
    internal class evolutionarystrategy
    {
        ...
        private string routingSolver = "LKH";
        ...
        public evolutionarystrategy(int p_seed, int p_M, int p_lambda, int p_size, int p_iteration, double p_sigma, int p_counter, double p_successrule, double[] p_l, double[] p_u, warehouse p_wh, bool p_allsearch, int p_computing, string p_routingsolver, double p_nft0, double p_nftlambda)
        {
            this.seed = p_seed;
            this.M = p_M;
            this.lambda = p_lambda;
